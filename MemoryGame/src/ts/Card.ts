import {Container, Sprite, Texture, BaseTexture, Rectangle,} from 'pixi.js';
  ...
  export class Card extends Container {
    ...
    constructor(back: string, coins:CardFront) {
      super();
      const frontTexture = this.getFrontTexture(coins);
      this.coins = this.createSprite(frontTexture);
      this.back = this.createSprite(getTexture(back) as Texture);
      this.name = coins.frame.name;
